...
export mdlist="pr4devbs14"                         ;#experiment names
...
export ftpdir=/home/people/emc/www/htdocs/gmb/$webhostid/vsdb/pr4devbs14
machine=WCOSS
...
export rundir=${rundir:-$STMP/$LOGNAME/track2014_wp_pr4devbs14}
mkdir -p ${rundir}; cd $rundir || exit 8


#==================================================================
for storm in Lingling Kajiki Faxai Peipah Tapah Hagibis Neoguri Rammasun Matmo Halong Nakri Fengshen Kalmaegi Fung-wong Kammuri Phanfone Vongfong Nuri Sinlaku Hagupit Halong ; do
 case $storm in 
  Lingling)       codd1=wp012014.dat; DATEST=20140118; DATEND=20140120;;
  Kajiki)         code1=wp022014.dat; DATEST=20140131; DATEND=20140202;;
  Faxai)          code1=wp032014.dat; DATEST=20140228; DATEND=20140305;;
  Peipah)         code1=wp052014.dat; DATEST=20140405; DATEND=20140414;;
  Tapah)          code1=wp062014.dat; DATEST=20140428; DATEND=20140430;;
  Hagibis)        code1=wp072014.dat; DATEST=20140614; DATEND=20140617;;
  Neoguri)        code1=wp082014.dat; DATEST=20140704; DATEND=20140710;;
  Rammasun)       code1=wp092014.dat; DATEST=20140712; DATEND=20140719;;
  Matmo)          code1=wp102014.dat; DATEST=20140718; DATEND=20140723;;
  Halong)         code1=wp112014.dat; DATEST=20140729; DATEND=20140810;;
  Nakri)          code1=wp122014.dat; DATEST=20140802; DATEND=20140804;;
  Fengshen)       code1=wp132014.dat; DATEST=20140907; DATEND=20140910;;
  Kalmaegi)       code1=wp152014.dat; DATEST=20140912; DATEND=20140916;;
  Fung-wong)      code1=wp162014.dat; DATEST=20140918; DATEND=20140923;;
  Kammuri)        code1=wp172014.dat; DATEST=20140924; DATEND=20140929;;
  Phanfone)       code1=wp182014.dat; DATEST=20140929; DATEND=20141006;;
  Vongfong)       code1=wp192014.dat; DATEST=20141003; DATEND=20141014;;
  Nuri)           code1=wp202014.dat; DATEST=20141031; DATEND=20141105;;
  Sinlaku)        code1=wp212014.dat; DATEST=20141128; DATEND=20141129;;
  Hagupit)        code1=wp222014.dat; DATEST=20141201; DATEND=20141202;;
  Halong)         code1=wp792014.dat; DATEST=20140729; DATEND=20140803;;
 esac  
OCEAN=WP
