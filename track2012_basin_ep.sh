...
## Fanglin Yang, March 2013: Generalized for running on CCS, WCOSS and THEIA

#-------------------------------------------------------------------------------------
export expdir=/global/noscrub/emc.glopara/archive      ;#experiment data archive directory
export mdlist="gfs2015 pr4devbs12"                              ;#experiment names
export mdplot="gfs2 gfsx"                                ;#names to be shown on plots, limitted to 4 letters
...
export ftpdir=/home/people/emc/www/htdocs/gmb/$webhostid/vsdb/pr4devbs12
machine=WCOSS
...
for storm in  Olivia Paul Rosa;do
 case $storm in
