...
#==================================================================
#for storm in Ana Bill Claudette Danny Erika Fred Grace Henri Ida Joaquin Kate Larry Mindy Nicholas Odette Peter Rose Sam Teresa Victor Wanda ; do

for storm in Ana Bill Claudette Danny Erika Fred Grace Henri Ida Joaquin Kate; do
 case $storm in
  Ana)       code1=al012015.dat; DATEST=20150508; DATEND=20150511;;
  Bill)      code1=al022015.dat; DATEST=20150616; DATEND=20150619;;
  Claudette) code1=al032015.dat; DATEST=20150713; DATEND=20150715;;
  Danny)     code1=al042015.dat; DATEST=20150818; DATEND=20150824;;
  Erika)     code1=al052015.dat; DATEST=20150825; DATEND=20150829;;
  Fred)      code1=al062015.dat; DATEST=20150830; DATEND=20150906;;
  Grace)     code1=al072015.dat; DATEST=20150905; DATEND=20150909;;
  Henri)     code1=al082015.dat; DATEST=20150910; DATEND=20150911;;
  Ida)       code1=al102015.dat; DATEST=20150919; DATEND=20150927;;
  Joaquin)   code1=al112015.dat; DATEST=20150928; DATEND=20151008;;
  Kate)      code1=al122015.dat; DATEST=20151109; DATEND=20151112;;
 esac
OCEAN=AL
