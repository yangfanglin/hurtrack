...
#==================================================================
#for storm in Amanda	Boris	Cristina	Douglas	Elida	Fausto	Genevieve	Hernan	Iselle	Julio	Karina	Lowell	Marie	Norbert	Odalys	Polo	Rachel  ; do
for storm in Amanda	Boris	Cristina; do
 case $storm in
  Amanda)    code1=ep012020.dat; DATEST=20200530; DATEND=20200531;;
  Boris)     code1=ep022020.dat; DATEST=20200624; DATEND=20200628;;
  Cristina)  code1=ep052020.dat; DATEST=20200706; DATEND=20200713;;
 esac
OCEAN=EP 
