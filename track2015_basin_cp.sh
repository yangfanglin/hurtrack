...
#==================================================================
for storm in Halola Iune Kilo Loke Malia Niala Oho; do
 case $storm in
  Halola)    code1=cp012015.dat; DATEST=20150710; DATEND=20150712;;
  Iune)      code1=cp022015.dat; DATEST=20150710; DATEND=20150713;;
  Kilo)      code1=cp032015.dat; DATEST=20150820; DATEND=20150901;;
  Loke)      code1=cp042015.dat; DATEST=20150821; DATEND=20150826;;
  Malia)     code1=cp052015.dat; DATEST=20150919; DATEND=20150922;;
  Niala)     code1=cp062015.dat; DATEST=20150925; DATEND=20150929;;
  Oho)       code1=cp072015.dat; DATEST=20151003; DATEND=20151008;;
 esac
OCEAN=CP
...
#TPC Atlantic and Eastern Pacific and Central Pacific tracks
if [ -s /nhc/noscrub/data/atcf-noaa/aid_nws/acp01${year}.dat ]; then
 tpcdata=/nhc/noscrub/data/atcf-noaa
 cp ${tpcdata}/aid_nws/acp*${year}*.dat  ${tpctrack}/.
 cp ${tpcdata}/btk/bcp*${year}*.dat      ${tpctrack}/.
elif [ -s $scrdir/tpctrack/${year}/acp01${year}.dat ]; then
 tpcdata=$scrdir/tpctrack
 cp ${tpcdata}/${year}/acp*.dat   ${tpctrack}/.
 cp ${tpcdata}/${year}/bcp*.dat   ${tpctrack}/.
else
...
if [ $BASIN = "CP" ]; then place="Central-Pacific"; fi
