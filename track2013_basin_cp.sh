...
export rundir=${rundir:-$STMP/$LOGNAME/track2013_cp_pr4devbs13}
mkdir -p ${rundir}; cd $rundir || exit 8


#==================================================================
for storm in Pewa Unala ; do
 case $storm in
  Pewa)          code1=cp012013.dat; DATEST=20130816; DATEND=20130818;;
  Unala)         code1=cp022013.dat; DATEST=20130819; DATEND=20130819;;
 esac
OCEAN=EP
