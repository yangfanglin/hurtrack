...
export rundir=${rundir:-$STMP/$LOGNAME/track2014_cp_pr4devbs14}
mkdir -p ${rundir}; cd $rundir || exit 8


#==================================================================
for storm in Wali Ana ; do
 case $storm in
  Wali)           code1=cp012014.dat; DATEST=20140718; DATEND=20140719;;
  Ana)            code1=cp022014.dat; DATEST=20141014; DATEND=20141026;;
 esac
OCEAN=CP
