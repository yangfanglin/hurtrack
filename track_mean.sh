...
export DATEST=20190601                                                   ;#forecast starting date
export DATEND=20190721                                                   ;#forecast ending date
...
cp ${execdir}/tracks_cp.i.txt ${savedir}/tracks_cp.t.txt
...
cp ${execdir}/tracks_cp.i.txt ${savedir}/tracks_cp.i.txt
