...
#==================================================================
#for storm in Arthur	Bertha	Cristobal	Dolly	Edouard	Fay	Gonzalo	Hanna	Isaias	Josephine	Kyle	Laura	Marco	Nana	Omar	Paulette	Rene	Sally	Teddy	Vicky	Wilfred; do
for storm in Arthur    Bertha  Cristobal   Dolly   Edouard Fay; do
 case $storm in
  Arthur)     code1=al012020.dat; DATEST=20200516; DATEND=20200519;;
  Bertha)     code1=al022020.dat; DATEST=20200527; DATEND=20200528;;
  Cristobal)  code1=al032020.dat; DATEST=20200601; DATEND=20200610;;
  Dolly)      code1=al042020.dat; DATEST=20200622; DATEND=20200624;;
  Edouard)    code1=al052020.dat; DATEST=20200704; DATEND=20200706;;
  Fay)        code1=al062020.dat; DATEST=20200709; DATEND=20200711;;
 esac
OCEAN=AL
